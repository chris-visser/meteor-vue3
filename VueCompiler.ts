...
export default class VueCompiler extends CachingCompiler {
  ...
  constructor(userOptions = {}) {
    ...
    // this.filterCustomBlock = createCustomBlockFilter(this.options.customBlocks)
  ...
  //   // exists, the file is not processed with the Vue compiler. Instead, the
  ...
  //   const bare = !!inputFile.getFileOptions().bare
  //
  //   const contents = inputFile.getContentsAsString();
  //   inputFile.addJavaScript({ path, hash, bare }, (
  //     () => this.transpileWithBabel(parse(contents).descriptor.script, path, arch === 'web.browser')
  //   ))
  //   // }
  // }
